...
pragma solidity =0.8.24 ^0.8.13 ^0.8.14 ^0.8.17 ^0.8.24;
...
// lib/seaport-types/src/interfaces/AmountDerivationErrors.sol
...
// lib/seaport-types/src/interfaces/SignatureVerificationErrors.sol
...
// lib/seaport-types/src/interfaces/ZoneInteractionErrors.sol
...
uint256 constant ThirtyOneBytes_0 = 0x1f;
...
uint256 constant TwoWordsShift_0 = 0x6;
...
uint256 constant CostPerWord_0 = 0x3;
uint256 constant MemoryExpansionCoefficientShift_0 = 0x9;
...
uint256 constant ThirtyOneBytes_1 = 0x1f;
uint256 constant OneWord_1 = 0x20;
uint256 constant TwoWords_1 = 0x40;
uint256 constant ThreeWords_1 = 0x60;

uint256 constant OneWordShift_1 = 0x5;
uint256 constant TwoWordsShift_1 = 0x6;
...
uint256 constant CostPerWord_1 = 0x3;
uint256 constant MemoryExpansionCoefficientShift_1 = 0x9;
...
// lib/seaport-types/src/interfaces/CriteriaResolutionErrors.sol
...
// lib/seaport-types/src/interfaces/FulfillmentApplicationErrors.sol
...
// lib/seaport-core/src/lib/AmountDeriver.sol
...
// lib/seaport-types/src/interfaces/ConsiderationEventsAndErrors.sol
...
// lib/seaport-core/src/lib/ConsiderationDecoder.sol
...
contract ConsiderationDecoder {
    ...
    function _decodeBytes(
        ...
        assembly {
            ...
            mPtrLength := mload(FreeMemoryPointerSlot_0)
            ...
            let size := add(
                and(
                    add(calldataload(cdPtrLength), ThirtyOneBytes_0),
                    OnlyFullWordMask
                ),
                OneWord_0
            )
            ...
            mstore(FreeMemoryPointerSlot_0, add(mPtrLength, size))
        }
    }
    ...
    function _decodeOffer(
        ...
        assembly {
            ...
            for {
                ...
                mPtrHeadNext := add(mPtrHeadNext, OneWord_0)
            ...
            mstore(FreeMemoryPointerSlot_0, mPtrTailNext)
        }
    }
    ...
    function _decodeOrdersAsAdvancedOrders(
        ...
        unchecked {
            ...
            uint256 tailOffset = arrLength << OneWordShift_0;

            // Add one additional word for the length and allocate memory.
            mPtrLength = malloc(tailOffset + OneWord_0);
            ...
            for (uint256 offset = 0; offset < tailOffset; offset += OneWord_0) {
    ...
    function _decodeCriteriaProof(
        ...
        unchecked {
            ...
            uint256 arrSize = (arrLength + 1) << OneWordShift_0;
        ...
        )
    {
        assembly {
            ...
            invalidEncoding := lt(returndatasize(), ThreeWords_0)
            ...
            if iszero(invalidEncoding) {
                ...
                returndatacopy(0, 0, TwoWords_0)
                offsetOffer := mload(0)
                offsetConsideration := mload(OneWord_0)

                // If valid length, check that offsets word boundaries are
                // within returndata.
                let invalidOfferOffset := gt(
                    add(offsetOffer, OneWord_0),
                    returndatasize()
                )
                let invalidConsiderationOffset := gt(
                    add(offsetConsideration, OneWord_0),
                    returndatasize()
                )
                ...
                if iszero(invalidEncoding) {
                    ...
                    returndatacopy(0, offsetOffer, OneWord_0)
                    offerLength := mload(0)

                    // Copy length of consideration array to scratch space.
                    returndatacopy(OneWord_0, offsetConsideration, OneWord_0)
                    considerationLength := mload(OneWord_0)
            ...
            function copySpentItemsAsOfferItems(
                ...
                let headOffsetFromLength := OneWord_0
                let headSizeWithLength := shl(OneWordShift_0, add(1, length))
                let mPtrTailNext := add(mPtrLength, headSizeWithLength)
                let mPtrTailOriginalNext := add(
                    mPtrLengthOriginal,
                    shl(OneWordShift_0, add(1, originalOfferLength))
                )
                ...
                for {
                    ...
                    headOffsetFromLength := add(headOffsetFromLength, OneWord_0)
                }
            ...
            function copyReceivedItemsAsConsiderationItems(
                ...
                let mPtrTailNext := add(
                    mPtrLength,
                    shl(OneWordShift_0, add(1, newLength))
                )
                let mPtrTailOriginalNext := add(
                    mPtrLengthOriginal,
                    shl(OneWordShift_0, add(1, originalConsiderationLength))
                )
...
// lib/seaport-core/src/lib/ConsiderationEncoder.sol
...
contract ConsiderationEncoder {
    ...
    function _encodeAuthorizeOrder(
        ...
        size -= (orderHashes.length - orderIndex) << OneWordShift_0;
    }
        ...
        )
    {
        ...
        unchecked {
            ...
            dstHead.offset(tailOffset + OneWord_0).writeBytes32(orderHash);
    ...
    function _encodeOrderHashes(
        ...
        unchecked {
            ...
            uint256 headAndTailSize = length << OneWordShift_0;
            ...
            size = headAndTailSize + OneWord_0;
        }
    }
    ...
    function _encodeSpentItems(
        ...
        assembly {
            ...
            // array data).
            let mPtrHead := add(srcLength, OneWord_0)
            ...
            // the array length.
            let cdPtrData := add(dstLength, OneWord_0)

            // Pointer to end of array head in memory.
            let mPtrHeadEnd := add(mPtrHead, shl(OneWordShift_0, length))
            ...
            for {
                ...
                mPtrHead := add(mPtrHead, OneWord_0)
                cdPtrData := add(cdPtrData, SpentItem_size)
            }

            size := add(OneWord_0, shl(SpentItem_size_shift, length))
        }
    }
    ...
    function _encodeConsiderationAsReceivedItems(
        ...
        unchecked {
            ...
            MemoryPointer srcHeadEnd = srcHead.offset(length << OneWordShift_0);
            ...
            size = OneWord_0 + (length * ReceivedItem_size);
        }
    }
}
        ...
        assembly {
            ...
            if returndatasize() {
                ...
                let returnDataWords := shr(
                    OneWordShift_0,
                    add(returndatasize(), ThirtyOneBytes_0)
                )
                ...
                if gt(returnDataWords, msizeWords) {
                    cost := add(
                        ...
                        add(
                            ...
                            shr(
                                MemoryExpansionCoefficientShift_0,
                                sub(
                    ...
                    if iszero(success) {
                        ...
                        if iszero(callStatus) {
                            ...
                            if returndatasize() {
                                ...
                                let returnDataWords := shr(
                                    OneWordShift_1,
                                    add(returndatasize(), ThirtyOneBytes_1)
                                )
                                ...
                                let msizeWords := shr(OneWordShift_1, memPointer)
                                ...
                                if gt(returnDataWords, msizeWords) {
                                    cost := add(
                                        ...
                                        add(
                                            ...
                                            shr(
                                                MemoryExpansionCoefficientShift_1,
                                                sub(
                                                    mul(
                                                        returnDataWords,
                                                        returnDataWords
            ...
            for {
                ...
                if iszero(success) {
                    ...
                    if returndatasize() {
                        ...
                        let msizeWords := shr(OneWordShift_1, transferDataSize)
...
// lib/seaport-core/src/lib/CriteriaResolution.sol
    ...
    function _verifyProof(
        ...
        assembly {
            ...
            for {
                ...
                let end := add(data, shl(OneWordShift_0, mload(proof)))
            } lt(data, end) {
                ...
                let scratch := shl(OneWordShift_0, gt(computedHash, loadedData))
...
// lib/seaport-core/src/lib/FulfillmentApplier.sol
    ...
    function _aggregateValidFulfillmentOfferItems(
        ...
        assembly {
            ...
            for {
                ...
                let endPtr := add(
                    offerComponents,
                    shl(OneWordShift_0, mload(offerComponents))
                )
                ...
                let orderPtr := mload(
                    ...
                    add(
                        ...
                        shl(OneWordShift_0, mload(mload(fulfillmentHeadPtr)))
                    )
                )
                ...
                case 1 {
                    ...
                    let firstFulfillmentHeadPtr := add(offerComponents, OneWord_0)
    ...
    function _aggregateValidFulfillmentConsiderationItems(
        ...
        assembly {
            ...
            for {
                ...
                let endPtr := add(
                    considerationComponents,
                    shl(OneWordShift_0, mload(considerationComponents))
                )
            } lt(fulfillmentHeadPtr, endPtr) {
...
// lib/seaport-core/src/lib/SignatureVerification.sol
...
// lib/seaport-core/src/lib/ConsiderationBase.sol
...
// lib/seaport-core/src/lib/ZoneInteraction.sol
    ...
    LowLevelHelpers
{
    ...
    function _assertRestrictedBasicOrderAuthorization(
        ...
        if (
            ...
            unchecked {
                ...
                callData.write(
                    ((size + OneWord_0) << 128) | memoryLocationForOrderHashes
                );
            }
        }
    }
    ...
    function _callAndCheckStatus(
        ...
        assembly {
            ...
            success := call(gas(), target, 0, callData, size, 0, OneWord_0)
...
// lib/seaport-core/src/lib/GettersAndDerivers.sol
...
contract GettersAndDerivers is ConsiderationBase {
    ...
    function _deriveOrderHash(
        ...
        assembly {
            ...
            offerHash := keccak256(
                mload(FreeMemoryPointerSlot_0),
                shl(OneWordShift_0, offerLength)
            )
        }
        ...
        assembly {
            ...
            considerationHash := keccak256(
                mload(FreeMemoryPointerSlot_0),
                shl(OneWordShift_0, originalConsiderationLength)
            )
        }
...
// lib/seaport-core/src/lib/CounterManager.sol
...
contract CounterManager is ConsiderationEventsAndErrors, ReentrancyGuard {
    ...
    function _incrementCounter() internal returns (uint256 newCounter) {
        ...
        assembly {
            ...
            mstore(OneWord_0, CounterManager._counters)

            // Derive the storage pointer for the counter value.
            let storagePointer := keccak256(0, TwoWords_0)
...
// lib/seaport-core/src/lib/Assertions.sol
...
// lib/seaport-core/src/lib/Verifiers.sol
...
contract Verifiers is Assertions, SignatureVerification {
    ...
    function _computeBulkOrderProof(
        ...
        assembly {
            ...
            height := shr(OneWordShift_0, sub(fullLength, signatureLength))

            // Update the length in memory to only include the signature.
            mstore(proofAndSignature, signatureLength)

            // Derive the pointer for the key using the signature length.
            let keyPtr := add(proofAndSignature, add(OneWord_0, signatureLength))
            ...
            // Compute level 1.
            let scratchPtr1 := shl(OneWordShift_0, and(key, 1))
            mstore(scratchPtr1, leaf)
            mstore(xor(scratchPtr1, OneWord_0), mload(proof))
            ...
            for {
                ...
                proof := add(proof, OneWord_0)
                let scratchPtr := shl(OneWordShift_0, and(shr(i, key), 1))
                mstore(scratchPtr, keccak256(0, TwoWords_0))
                mstore(xor(scratchPtr, OneWord_0), mload(proof))
            }

            // Compute root hash.
            root := keccak256(0, TwoWords_0)
        }
        ...
        assembly {
            ...
            mstore(OneWord_0, root)
            bulkOrderHash := keccak256(0, TwoWords_0)
        }
    }
...
// lib/seaport-core/src/lib/Executor.sol
...
// lib/seaport-core/src/lib/OrderValidator.sol
        ...
        assembly {
            ...
            conduitKey := calldataload(
                add(
                    ...
                    shl(OneWordShift_0, offerTypeIsAdditionalRecipientsType)
                )
            )
        }
            ...
            assembly {
                ...
                for {
                    ...
                    combinedAdditionalRecipients := or(
                        ...
                        calldataload(add(additionalRecipientCdPtr, OneWord_0))
                    )
                ...
                mstore(
                    ...
                    keccak256(
                        BasicOrder_considerationHashesArray_ptr,
                        shl(OneWordShift_0, add(totalAdditionalRecipients, 1))
                    )
                )
            ...
            for (
                ...
                assembly {
                    ...
                    recipient := calldataload(
                        add(OneWord_0, additionalRecipientCdPtr)
                    )
                }
        ...
        assembly {
            ...
            conduitKey := calldataload(
                sub(
                    ...
                    shl(OneWordShift_0, fromOfferer)
                )
            )
        }
...
// lib/seaport-core/src/lib/OrderFulfiller.sol
...
// lib/seaport-core/src/lib/OrderCombiner.sol
...
contract OrderCombiner is OrderFulfiller, FulfillmentApplier {
    ...
    function _validateOrdersAndPrepareToFulfill(
        ...
        unchecked {
            ...
            // Iterate over each order.
            for (uint256 i = OneWord_0; i < terminalMemoryOffset; i += OneWord_0) {
